  ...
  return (
    <>
      <div className=" text-white/70 pt-6">
        ...
        <div
          onClick={toggleNav}
          className="md:hidden absolute cursor-pointer top right-5 border rounded text-white/70 border-white/70 p-2 z-50"
        >
        ...
        >
          <ul className=" text-4xl font-semibold my-24 text-center">
            {navLinks.map((link, index) => (
              <li key={index}>
